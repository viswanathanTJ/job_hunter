...
export default function Dashboard() {
  ...
  const fetchingSource = (src) => ops.some((o) => o.type === 'fetch' && o.source === src && o.state === 'running');
            ...
            {stats.lastFetch ? (
              <div className="activity">
                <div className="line">
                  ...
                  {stats.lastFetch.source && (
                    <span className="mono" style={{ fontSize: 11 }}>
                      {stats.lastFetch.source}
                    </span>
                  )}
                  <span className="mono" style={{ fontSize: 11 }}>
                    {relTime(stats.lastFetch.started_at)}
                  </span>
                </div>
                <div className="line">
                  found {stats.lastFetch.found} · new {stats.lastFetch.imported} · updated {stats.lastFetch.updated}
                </div>
